# Auth Routes and Controller (OTP + JWT Auth)

_/utils/file.manager.js_
...
_/controllers/auth.conrroller.js_
...
const register = async (req, res) => {
  ...
  if (emailDomain !== "bansberrysg.com") {
    return res
      .status(400)
      .json({ message: "Email must be from bansberrysg.com domain" });
  }
